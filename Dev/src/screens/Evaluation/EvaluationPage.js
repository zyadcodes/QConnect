...
export class EvaluationPage extends QcParentScreen {
	...
	render() {
		...
		headerTitle = readOnly
			? strings.Completed + ': ' + this.props.navigation.state.params.completionDate
			...
			<QCView style={screenStyle.container}>
				<ScrollView>
					{this.props.navigation.state.params.newAssignment === true ? (
						...
						/>
					) : readOnly === true && !this.props.navigation.state.params.isStudentSide ? (
						<TopBanner
							LeftIconName='angle-left'
							LeftOnPress={() => this.props.navigation.goBack()}
							Title={strings.Evaluation}
					...
					<View style={styles.evaluationContainer}>
						<View style={styles.section}>
							<Image source={studentImages.images[profileImageID]} style={styles.profilePic} />
							...
							<FlowLayout
								...
								initialSelectedValues={
									this.props.navigation.state.params.newAssignment === false
										? this.props.navigation.state.params.evaluationObject.improvementAreas
										: []
								}
