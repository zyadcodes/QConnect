...
import { KeyboardAvoidingView, TextInput, View, Image, StyleSheet } from 'react-native'
    ...
    render(){
        return (
            <Modal         
                ...
                style={{backgroundColor: colors.primaryVeryLight, maxWidth: screenWidth*0.9, alignSelf: 'center', justifyContent: 'space-between'}}
            >
                <ScrollView style={{flex: 1, marginTop: screenHeight/40}}>
                    <FeedsObject
                        ...
                        viewableBy={this.props.item.viewableBy === undefined ? null : this.props.item.viewableBy}
                        role={this.props.role}
                        content={this.props.item.content}
                        number={this.props.objectIndex}
                        studentClassInfo={
                        this.props.item.type === 'assignment' && this.props.role === 'student'
                        ...
                        beginCommenting={(objectIndex) => this.props.beginCommenting(this.props.listIndex, objectIndex)}
                        onPressSelectEmoji={() => this.props.onPressSelectEmoji(this.props.objectIndex)}
