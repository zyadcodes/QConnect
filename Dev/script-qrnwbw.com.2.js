...
/*! Bootstrap v4.1.1 | Copyright 2011-2018 The Bootstrap Authors | Includes utils.js, modal.js, collapse.js and dropdown.js */
!(function(e, t) {
  ...
  (function(e, t) {
      ...
      y = (function() {
        ...
        return (
            ...
            if (!this._isShown && !this._isTransitioning) {
              ...
              e(this._element).trigger(i),
                this._isShown ||
                  ...
                  e(this._element).on(d.CLICK_DISMISS, p.DATA_DISMISS, function(
                    e
                  ) {
                    return n.hide(e);
                  }),
          ...
          (b._getConfig = function(e) {
            return (e = r({}, l, e)), t.typeCheckConfig(o, e, c), e;
          }),
          (b._showElement = function(n) {
            var i = this,
              r = e(this._element).hasClass(_);
            (this._element.parentNode &&
              ...
              r && t.reflow(this._element),
              e(this._element).addClass(m),
              this._config.focus && this._enforceFocus();
            var o = e.Event(d.SHOWN, { relatedTarget: n }),
              s = function() {
          ...
          (b._showBackdrop = function(n) {
            var i = this,
              r = e(this._element).hasClass(_) ? _ : "";
    ...
    return (
      e(document).on(d.CLICK_DATA_API, p.DATA_TOGGLE, function(n) {
        var i,
          o = this,
  ...
  (function(e, t) {
    ...
    var o = "collapse",
      ...
      y = (function() {
        ...
        return (
          ...
          (b._getConfig = function(e) {
            return (
              ((e = r({}, l, e)).toggle = Boolean(e.toggle)),
    ...
    return (
      ...
      (e.fn[o] = y._jQueryInterface),
      (e.fn[o].Constructor = y),
      (e.fn[o].noConflict = function() {
        return (e.fn[o] = a), y._jQueryInterface;
      }),
      y
    );
  }),
  (function(e, t) {
      ...
      P = (function() {
        ...
        return (
          ...
          (j._getPlacement = function() {
            ...
            return (
              t.hasClass(g)
                ? ((n = w), e(this._menu).hasClass(p) && (n = D))
                : t.hasClass(_)
                ? (n = A)
                : t.hasClass(m)
                ? (n = O)
                : e(this._menu).hasClass(p) && (n = T),
              n
            );
          }),
          ...
          (r._jQueryInterface = function(t) {
            return this.each(function() {
              ...
              if (
                (n ||
                  ((n = new r(this, "object" == typeof t ? t : null)),
                  e(this).data(a, n)),
                "string" == typeof t)
              ) {
                if (void 0 === n[t])
    ...
    return (
      e(document)
        .on(h.KEYDOWN_DATA_API, v, P._dataApiKeydownHandler)
        .on(h.KEYDOWN_DATA_API, E, P._dataApiKeydownHandler)
        .on(h.CLICK_DATA_API + " " + h.KEYUP_DATA_API, P._clearMenus)
        .on(h.CLICK_DATA_API, v, function(t) {
          t.preventDefault(),
            t.stopPropagation(),
            P._jQueryInterface.call(e(this), "toggle");
        })
        .on(h.CLICK_DATA_API, b, function(e) {
          e.stopPropagation();
        }),
      (e.fn[s] = P._jQueryInterface),
      (e.fn[s].Constructor = P),
      (e.fn[s].noConflict = function() {
        return (e.fn[s] = c), P._jQueryInterface;
      }),
      P
    );
  });
